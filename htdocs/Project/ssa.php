    ...
    <div class="container" style="max-width:1280px;">
      <div class="panel panel-primary">
        <div class="panel-heading" style="text-align:center;">
            <h1>Subject Specific Areas Navigation</h1>
        </div>
        <div class="panel-body">

          <a href='softdev.php'class="btn btn-default btn-block">Software Development</a>

          <a href='webdev.php'class="btn btn-default btn-block">Website Development</a>

          <a href='compnet.php'class="btn btn-default btn-block">Computer Networks</a>

          <a href='comphard.php'class="btn btn-default btn-block">Computer Hardware and Architecture</a>

          <a href='compgame.php'class="btn btn-default btn-block">Computer Games Design and Development</a>
